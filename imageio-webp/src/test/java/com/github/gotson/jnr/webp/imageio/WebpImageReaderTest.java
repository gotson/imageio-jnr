...
import static com.github.gotson.jnr.webp.imageio.CustomAssertions.assertThat;
...
class WebpImageReaderTest {
  ...
  public void testReaderIsRegistered() {
    ...
    Assertions.assertThat(getReaderIter.get()).isNotEmpty();
    Assertions.assertThat(getReaderIter.get()).hasAtLeastOneElementOfType(WebpImageReader.class);
  ...
  private WebpImageReader getReader(String fixtureFile) throws IOException {
    ...
    Assertions.assertThat(reader).isInstanceOf(WebpImageReader.class);
    reader.setInput(is);
    return (WebpImageReader) reader;
  }

  @Test
  public void testRead() throws IOException {
    BufferedImage img = ((ImageReader) getReader("lossy.webp")).read(0, null);
    ImageIO.write(img, "png", new File("/Users/groebroeck/Downloads/out.png"));
    CustomAssertions.assertThat(img).hasDimensions(1024, 752);
  }
  ...
  public void testReadScaled() throws IOException {
    ...
    ImageIO.write(img, "png", new File("/Users/groebroeck/Downloads/out.png"));
    CustomAssertions.assertThat(img).hasDimensions(400, 301);
  }
  ...
  public void testReadRegionAligned() throws IOException {
    ...
    CustomAssertions.assertThat(img).hasDimensions(96, 96).hasNoPixelsOfColor(-1 /* white */);
  }
  ...
  public void testReadRegionUnaligned() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(204, 172).hasNoPixelsOfColor(-1 /* white */);
  }
  ...
  public void testReadUnalignedScaled() throws IOException {
    ...
    CustomAssertions.assertThat(img).hasDimensions(152, 129).hasNoPixelsOfColor(-1 /* white */);
  }

  @Test
  public void testReadUnalignedRotated() throws IOException {
    ImageReader reader = getReader("crop_unaligned_rot90.jpg");
    WebpImageReadParam param = (WebpImageReadParam) reader.getDefaultReadParam();
    param.setSourceRegion(new Rectangle(16, 16, 339, 319));
    param.setRotationDegree(90);
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(319, 339).hasNoPixelsOfColor(-1 /* white */);
    param.setRotationDegree(180);
    img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(339, 319).hasNoPixelsOfColor(-1 /* white */);
  ...
  public void testReadRotated() throws IOException {
    ...
    CustomAssertions.assertThat(img).hasNoPixelsOfColor(-1);
  }
  ...
  public void testReadRegionRotated() throws IOException {
    ...
    param.setRotationDegree(90);
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(172, 204).hasNoPixelsOfColor(-1 /* white */);
    param.setRotationDegree(180);
    img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(204, 172).hasNoPixelsOfColor(-1 /* white */);
    param.setRotationDegree(270);
  ...
  public void testReadRegionRotatedFullWidth() throws IOException {
    ...
    CustomAssertions.assertThat(img).hasDimensions(368, 384).hasNoPixelsOfColor(-1 /* white */);
    param.setRotationDegree(180);
    img = reader.read(1, param);
    CustomAssertions.assertThat(img).hasDimensions(384, 368).hasNoPixelsOfColor(-1 /* white */);
    param.setRotationDegree(270);
    img = reader.read(1, param);
    CustomAssertions.assertThat(img).hasDimensions(368, 384).hasNoPixelsOfColor(-1 /* white */);
  }
  ...
  public void testCanReuseReader() throws IOException {
    ...
    Assertions.assertThat(rgbImg.getRGB(256, 256)).isNotEqualTo(bwImg.getRGB(256, 256));
  }
  ...
  public void testCropFullWidth() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(521, 172);
  }
  ...
  public void testCropFullWidthOffset() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(500, 172);
  }
  ...
  public void testCropFullHeight() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(172, 509);
  }
  ...
  public void testCropFullHeightOffset() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(172, 500);
  }
  ...
  public void testUnalignedCropOnPrimeShaped() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(239, 397).hasNoPixelsOfColor(-1);
  }
  ...
  public void testCropFullImageScaled() throws IOException {
    ...
    BufferedImage img = reader.read(2, param);
    CustomAssertions.assertThat(img).hasDimensions(reader.getWidth(2), reader.getHeight(2));
  }
  ...
  public void testReadTinyImage() throws IOException {
    ...
    BufferedImage img = reader.read(0, param);
    Assertions.assertThat(img.getWidth()).isEqualTo(1);
    Assertions.assertThat(img.getHeight()).isEqualTo(1);
  }
  ...
  public void testReadCMYKDelegatesToDefault() throws IOException {
    ...
    ImageInputStream is = ImageIO.createImageInputStream(inFile);
    ImageReader reader = ImageIO.getImageReaders(is).next();
    Assertions.assertThat(reader).isNotInstanceOf(WebpImageReader.class);
  }
  ...
  public void testDoubleFreeCrash() throws IOException {
    ...
    Assertions.assertThat(img.getWidth()).isEqualTo(180);
    Assertions.assertThat(img.getHeight()).isEqualTo(136);
  }
  ...
  public void testCroppingRequiresReallocation() throws IOException {
    ...
    Assertions.assertThat(img.getWidth()).isEqualTo(365);
    Assertions.assertThat(img.getHeight()).isEqualTo(10);
  }

  @Test
  void testAdjustMCURegion() {
    WebpImageReader reader = new WebpImageReader(null, null);
    ...
    Assertions.assertThat(region).isEqualTo(regionExpected);
    Assertions.assertThat(extraCrop).isEqualTo(extraCropExpected);
  }

  @Test
  public void testReadGrayscale() throws IOException {
    ImageReader reader = getReader("grayscale.jpg");
    Assertions.assertThat(reader.getRawImageType(0).getNumComponents()).isEqualTo(1);
    WebpImageReadParam param = (WebpImageReadParam) reader.getDefaultReadParam();
    BufferedImage img = reader.read(0, param);
    CustomAssertions.assertThat(img).hasDimensions(1955, 524);
    Assertions.assertThat(img.getType()).isEqualTo(BufferedImage.TYPE_BYTE_GRAY);
    ...
    CustomAssertions.assertThat(img).isEqualTo(controlImg);
  }
}
